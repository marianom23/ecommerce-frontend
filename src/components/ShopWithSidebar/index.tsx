        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-7.5">
            ...
            >
              ...
              >
                <SlidersHorizontal className="h-5 w-5 text-dark" />
              </button>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  {facetsLoading && (
                    <div className="space-y-3 px-5">
                      <InlineFieldSkeleton className="w-full" />
                      <InlineFieldSkeleton className="w-4/5" />
                      <InlineFieldSkeleton className="w-3/5" />
                    </div>
                  )}
                  ...
                  {facetsLoading && (
                    <div className="space-y-3 px-5">
                      <InlineFieldSkeleton className="w-full" />
                      <InlineFieldSkeleton className="w-2/3" />
                    </div>
                  )}
                  {facetsError && !facetsLoading && <p className="px-5 text-sm text-red-500">{facetsError}</p>}
                </div>
