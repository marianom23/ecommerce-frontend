  ...
  return (
    <footer className="overflow-hidden">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        {/* <!-- footer menu start --> */}
        <div className="grid grid-cols-2 gap-8 md:gap-10 xl:flex xl:flex-nowrap xl:gap-19 xl:justify-between pt-12 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="col-span-2 xl:w-auto xl:max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a href="https://wa.me/5492614689151" target="_blank" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          <div className="col-span-1 w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="/mi-cuenta">
                  Mi Cuenta
                </a>
              </li>
              <li>
              ...
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="/productos">
                  Productos
                </a>
              </li>
            </ul>
          ...
          <div className="col-span-1 w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a className="ease-out duration-200 hover:text-blue" href="/como-funciona">
                  Cómo Funciona
                </a>
              </li>
              <li>
      ...
      <div className="py-5 xl:py-7.5 bg-gray-1">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex flex-col md:flex-row gap-5 flex-wrap items-center justify-center md:justify-between text-center md:text-left">
